...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Note that the immiscibility with and lower density than water are the two key properties we look for in the solvent we use for such a reaction. Toluene is a common choice, but not the only possible one. 
        \end{itemize}
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{itemize}
    \end{itemize}
    \item \textbf{Cyanohydrin}: The class of molecules resultin from the nucleophilic addition of \ce{HCN} to a ketone or aldehyde. \emph{Structure}
    \begin{figure}[h!]
        \centering
        \footnotesize
