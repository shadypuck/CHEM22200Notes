...
\chapter{Carbonyl Compounds' \texorpdfstring{$\bm{\alpha}$}{TEXT}-Carbons}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Unit 3 talks about carbonyls as nucleophiles (when they've been deprotonated at the $\alpha$-position).
    \end{itemize}
    ...
    \begin{figure}[h!]
        ...
        \schemestop
        \chemmove{
            \draw [curved arrow={10pt}{2pt}] (C1) to[bend right=100,looseness=6] (sb1);
            \draw [curved arrow={3pt}{2pt}] (db1) to[bend right=90,looseness=3] (O1);
        }
        \caption{Enolate.}
        \label{fig:enolate}
    \end{figure}
    ...
    \item $\pKa$'s.
    \begin{itemize}
        \item Deprotonating an \ce{O-H} bond: Recall that acetic acid ($\pKa\approx 15$) is $10^{10}$ times more acidic than ethanol ($\pKa\approx 5$) due to resonance stabilization of the conjugate base in the former.
    ...
    \end{itemize}
    \item Levin also draws the reverse mechanism for both of these as per the principle of microscopic reversibility.
    \begin{itemize}
        \item It follows that there is an equilibrium between a ketone and its enol.
    \end{itemize}
    \item The position of the equilibrium depends largely on the resonance stability of both tautomers.
    \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item Note that \ce{D2O / DO-} denotes basic deuterated water, and that only acidic or basic deuterated water is used at one time.
        \end{itemize}
    ...
    \begin{itemize}
        \item More generally, any trihalomethane has an old-school, common -form name. For example, we alo have \textbf{chloroform} (trichloromethane) and \textbf{iodoform} (triiodomethane).
    \end{itemize}
    \item Mechanism.
    \begin{figure}[h!]
        \centering
