...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item \ce{O} l.p. makes new \ce{O-H} bond.
            \item \ce{C-H} bond breaks and electrons make a new \ce{C=O} $\pi$ bond.
    ...
    \end{center}
    \begin{itemize}
        \item \emph{cis}-diols react faster, but aren't necessarily required.
    \end{itemize}
    \item Mechanism.
    \begin{figure}[h!]
        \centering
    ...
    \end{center}
    \begin{itemize}
        \item Every place gold is we can use mercury instead, but since gold is less toxic and more active, we prefer to use it (even though it's more expensive). Any of the soft Lewis acid transition metals in the bottom-right corner island will work, though\footnote{Gold acts as a soft $\pi$-Lewis acid here! Just like in the Gold MOL project from Lin lab \parencite{bib:GoldMOLProject}.}.
    \end{itemize}
    \item Mechanism.
    \begin{figure}[h!]
        \centering
    ...
    \end{figure}
    \begin{itemize}
        \item We won't need to know the arrow-pushing mechanism for the final tautomerization until Unit 3.
        \item Recall this enol-keto tautomerization from first quarter, specifically Figure 7.6 of \textcite{bib:CHEM22000Notes}.
        \begin{itemize}
            \item At the same time, we alluded to a catalytic mechanism using \ce{HgSO4}; this mechanism is presumably very similar to the above, since mercury is like gold as mentioned earlier.
        \end{itemize}
    \end{itemize}
    \item Alkyne hydroboration.
    \item General form.
...
\begin{itemize}
    ...
    \end{itemize}
    \item Note that \ce{H3O+} or \ce{H+} is an abbreviation for some strong acid in solution, but there is always a counterion present; even a couple of excess positive molecules would generate a huge static field.
    \item \textbf{Ketal}: The product of the nucleophilic addition of an alcohol (\ce{ROH}) to a ketone. \emph{Structure}
    \begin{figure}[h!]
        \centering
        \footnotesize
        ...
        \label{fig:ketal}
    \end{figure}
    \item \textbf{Acetal}: The product of the nucleophilic addition of an alcohol (\ce{ROH}) to an aldehyde. \emph{Structure}
    \begin{figure}[h!]
        \centering
        \footnotesize
    ...
    \begin{itemize}
        \item \ce{Me2COH+ + MeOH <=>> Me2CO + MeOH2+}: $K\approx 100$.
        \begin{itemize}
        ...
        \end{itemize}
        \item \ce{Me2COH+ + MeNH2 <=>> Me2CO + MeNH3+}: $K\approx 10^{16}$.
        \begin{itemize}
    ...
    \begin{itemize}
        \item Also commonly written \ce{N2H4}.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Additionally, the increased $s$ character in the product (\ce{N} is $sp^2$ in an oxime, $sp^3$ in hydroxylamine) means that the lone pair on nitrogen is held tighter in the product and hence experiences a diminished $\alpha$-effect there.
        \end{itemize}
        \item Hydrazones.
        \begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \schemestart
            ...
            \chemright{]}
            \arrow{->[*{0}\chemfig{@{O3}\charge{-90=\:,135:1pt=$\ominus$}{O}H}][*{0}-\ce{H2O}]}[90]
            \chemfig{-[:30]@{C4}\charge{45:2pt=$\ominus$}{}(-[2]N=[:30]N-[:-30]H)-[:-30]}
            \arrow{->[\chemfig[atom sep=1.4em]{@{H5}H-[@{sb5}]@{O5}OH}][*{0}-\ce{OH-}]}[,1.2]
            \chemfig{-[:30](-[:110]N=[::-60]@{N6}N-[@{sb6}::-60]@{H6}H)(-[:70]H)-[:-30]}
            \arrow{->[\chemfig{@{O7}\charge{90=\:,135:1pt=$\ominus$}{O}H}][-\ce{H2O}]}
            \chemfig{-[:30]@{C8}(-[@{sb8,0.6}:110]N=[@{db8}::-60]@{N8}\charge{90=\:,45:1pt=$\ominus$}{N})(-[:70]H)-[:-30]}
            \arrow{->[][-\ce{N2}]}
            \chemfig{-[:30]@{C9}\charge{45:2pt=$\ominus$}{}(-[2]H)-[:-30]}
            \arrow{->[\chemfig[atom sep=1.4em]{@{H10}H-[@{sb10}]@{O10}OH}][*{0}-\ce{OH-}]}[,1.2]
            \chemfig{-[:30](-[:110]H)(-[:70]H)-[:-30]}
        \schemestop
        \chemmove{
            ...
            \draw [curved arrow={2pt}{2pt}] (sb5) to[bend left=90,looseness=3] (O5);
            \draw [curved arrow={6pt}{2pt}] (O7) to[out=90,in=30,looseness=1.5] (H6);
        ...
        \caption{Wolff-Kishner reduction mechanism.}
        \label{fig:mechanismWolffKishner}
    \end{figure}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Enamine}: The product of the nucleophilic addition of a dialkyl amine (\ce{R2NH}) to a carbonyl group. \emph{Structure}
    \begin{figure}[h!]
        \centering
        \footnotesize
    ...
    \begin{center}
        ...
        \schemestop
    \end{center}
    \item \textbf{Iminium}: An ion containing a \ce{C=N+} double bond. \emph{Structure}
    \begin{figure}[h!]
        \centering
        \footnotesize
...
\begin{itemize}
    ...
    \item Aluminum hydride derivatives less reactive than \ce{LiAlH4} include DIBAL-H (more on this later in the course) and lithium tri-\emph{tert}-butoxy-aluminum hydride.
